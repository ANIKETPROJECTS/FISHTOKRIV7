        ...
        <AnimatePresence>
          {showWhatsAppNotif && (
            <motion.div
              ...
              className="fixed top-4 z-[200] pointer-events-none"
              style={{ left: "50%", transform: "translateX(-50%)", width: "max-content", maxWidth: "calc(100vw - 32px)" }}
            >
              <div className="flex items-center gap-2 px-4 py-2 rounded-full shadow-xl" style={{ backgroundColor: "#16a34a" }}>
                ...
                <span className="text-white text-sm font-semibold">OTP sent on your registered WhatsApp number</span>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
